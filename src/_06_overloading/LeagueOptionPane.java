...
public class LeagueOptionPane {
	...
	public static void twoShowMessageDialogue(String title, String message) {
	...
	public static void threeShowMessageDialogue(String fileName, String title, String message) {
